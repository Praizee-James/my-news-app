...
const Navbar: FC = () => {
    ...
    return (
        ...
        <div className='bg-blue-900 text-white gap-3 items-center'>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent:'space-between', width:'90%', mx: 'auto', py:1, gap:2}}>
                ...
                <Box sx={{display:'flex', alignItems:'center', color:'c2c2c2',  gap:2,  px:4, borderRadius:'999px' }} className = 'bg-blue-800'>
                    ...
                    <InputBase sx={{color:'white',width : '350px', height:'[2.5rem]', fontSize:'1rem', fontFamily:'serif', '&::placeholder' :{
                        color:'#646464'
...
{categories.map((item,ind) => (
    <Button key={ind} sx={{fontSize:'12px'}} className="min-w-fit, w-full hover:bg-blue-900">
